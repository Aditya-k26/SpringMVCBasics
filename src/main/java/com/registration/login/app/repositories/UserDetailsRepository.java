...
public interface UserDetailsRepository extends JpaRepository<UserDetails, Integer> {
	...
	@Query(value = "select * from user_details u where  u.username= :username AND u.password = :password", nativeQuery = true)
	public UserDetails findByPassword(String password, String username);

	@Modifying(clearAutomatically = true, flushAutomatically = true)
	@Transactional
	@Query(value = "update user_details SET failed_tries = :failedTries where username = :username ", nativeQuery = true)
	public void updateUserFailedTries(String username, Integer failedTries);

	@Modifying(clearAutomatically = true, flushAutomatically = true)
	@Transactional
	@Query(value = "update user_details SET locked = :isLocked where  username = :username ", nativeQuery = true)
